...
class  OpenaiAPI:
    def __init__(self, api_key_list:List[str], base_url: str="https://api.adamchatbot.chat/v1", organization: str=None, model_name:str="gpt-4-0613", temperature:float=0.3, max_tokens: int=4096):
