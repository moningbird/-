...
def obj_score_eval(obj_output_dir: str) -> None:
    ...
    for file in obj_files:
        ...
        s_rate = round(c_score / (t_score if t_score!=0 else 1), 3)
    ...
    for value in score_dict['subject'].values():
        value['scoring_rate'] = round(value['correct_score'] / (value['total_score'] if value['total_score']!=0 else 1), 3)
    ...
    score_dict['scoring_rate'] = round(c_score / (t_score if c_score!=0 else 1), 3)
